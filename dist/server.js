...
var aboutRoutes_1 = __importDefault(require("./routes/aboutRoutes"));
var serviceRoutes_1 = __importDefault(require("./routes/serviceRoutes"));
var resumeRoutes_1 = __importDefault(require("./routes/resumeRoutes"));
...
function connect_to_database() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    options = { dbName: "Portfolio" };
                    mongoose_1.default.set('strictQuery', true);
                    return [4 /*yield*/, mongoose_1.default.connect("".concat(process.env.MONGO_DB_URI), options)
                            .then(function () { return console.log("Connected to Mongo DB"); })
                            .catch(function (err) { return console.error("Unable to connect to database...", err); })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
